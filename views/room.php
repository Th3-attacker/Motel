  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <form method="POST" action="">
        ...
        <input type="hidden" value="12" />
        <div class="card">
          <img class="card-img-top" src="./public/images/2.jpg" alt="Room image description"/>
          <div class="card-body">
            <div class="rooms_title"><h2>Wing A Standard Room</h2></div>
            <div class="rooms_text">
              <p>Without TV</p>
  ...
  <div class="row mt-5">
    <div class="col-md-4">
      <form method="POST" action="">
        ...
        <input type="hidden" value="12" />
        <div class="card">
          <img class="card-img-top" src="./public/images/4.jpg" alt="Room image description"/>
          <div class="card-body">
            <div class="rooms_title"><h2>Wing A Standard Room</h2></div>
            <div class="rooms_text">
              <p>Without TV</p>
    ...
    <div class="col-md-4">
      <form method="POST" action="">
        ...
        <input type="hidden" value="12" />
        <div class="card">
          <img class="card-img-top" src="./public/images/5.jpg" alt="Room image description"/>
          <div class="card-body">
            <div class="rooms_title"><h2>Wing A Standard Room</h2></div>
            <div class="rooms_text">
              <p>Without TV</p>

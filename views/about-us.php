      ...
      <div class="row row-eq-height">
        ...
        <div class="col-lg-6">
          <div class="intro_image">
            <div class="background_image" style="background-image:url(./public/images/intro.jpg)"></div>
    ...
    <div class="container">
      ...
      <div class="row offering_row">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            <div class="offer_image"><img src="./public/images/offer_1.jpg" alt=""></div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            <div class="offer_image"><img src="./public/images/offer_2.jpg" alt=""></div>
            <div class="offer_content text-center">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            <div class="offer_image"><img src="./public/images/offer_3.jpg" alt=""></div>
            <div class="offer_content text-center">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            <div class="offer_image"><img src="./public/images/offer_4.jpg" alt=""></div>
            <div class="offer_content text-center">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            <div class="offer_image"><img src="./public/images/offer_5.jpg" alt=""></div>
            <div class="offer_content text-center">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            <div class="offer_image"><img src="./public/images/offer_6.jpg" alt=""></div>
            <div class="offer_content text-center">
